...
link1_status=$(curl -Is https://archive.org/download/6001.18000.0801181840x86freserverenuskrmsfreendvd/6001.18000.080118-1840_x86fre_Server_en-us-KRMSFRE_EN_DVD.iso | grep HTTP | cut -f2 -d" " | head -1)
