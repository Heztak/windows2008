...
link2_status=$(curl -Is https://archive.org/download/ayuda_202101/ayuda.iso.ISO | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	...
	sudo wget -P /mediabots https://archive.org/download/ayuda_202101/ayuda.iso.iso
else
